...
Similar to MTL4, the ViennaCL version of the system function object is split into two parts:
...
The top row in each figure shows the performance obtained from CPU-based
