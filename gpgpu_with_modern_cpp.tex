...
and can be fused with other expressions---denoted by \code{||}. 
...
is significant: we observed 150\,\% overhead with 3~vector with 4k entries compared
to one vector of size 12k.
In the following, we will refer to the CUDA
version of MTL4 as CMTL4.
