...
templates \cite{Veldhuizen:ExpressionTemplates,Vandevoorde:CppTemplates} for the elementary operations using operator overload convenience.
...
Although performance obtained via CUDA a few percent better than that of OpenCL on the overall,
