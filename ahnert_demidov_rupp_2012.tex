...
Numerous methods for solving ODEs exist \cite{HairerSolvingODEI,
  HairerSolvingODEII, HairerGeometricNumericalIntegration2006}, % [KR]: I would prefer a more diverse set of authors here (not just Hairer), % These are the standard books
