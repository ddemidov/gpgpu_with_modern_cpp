...
example, where ViennaCL is the fastest library. The performance of ViennaCL for
the rest of the examples on the CPU is poor and is about 75 percent below that
of Thrust and between 30 and 70 percent below that of VexCL.  The difference
...
performance difference between the implementations here reaches 50\%. This
probably has something to do with the fact that this example was hand-coded for
ViennaCL and Intel's OpenCL compiler was able to apply some effective
optimizations.
