...
ordinary differential equations (ODEs) numerically that has been      %[KR]: This is repeated in the first item below.
accepted for inclusion into the Boost libraries\footnote{ \href{
http://boost.org } { http://boost.org } } recently.  The GPGPU libraries considered in
