...
In the next subsection we describe odeint adaptation for GPGPU libraries under
consideration.
...
\begin{figure}
	...
	]{\includegraphics[width=0.4\textwidth]{data/disordered_lattice/scaling}}\\
	\subfigure[
